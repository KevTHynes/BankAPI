...
URI: http://localhost:49000/api/customers/createCustomer
HTTP verb: POST
...
URI: http://localhost:49000/api/customers
HTTP verb: GET
Parameters: Null
Resource contents:
“Enter screenshot here”
...
URI: http://localhost:49000/api/customers/{id}
HTTP verb: GET
...
URI: http://localhost:49000/api/customers?name={name}
HTTP verb: GET
...
URI: http://localhost:49000/api/customers/{customerId}/accounts/{accountId}
HTTP verb: GET
...
URI: http://localhost:49000/api/customers/{email}/{pin}/newAccount
HTTP verb: POST
...
URI: http://localhost:49000/api/customers/{customerId}/accounts/{accountId}/withdraw/{amount}
HTTP verb: PUT
...
URI: http://localhost:49000/api/customers/{customerId}/accounts/{accountId}/deposit/{amount}
HTTP verb: PUT
Parameters: The path parameter is a customer id (int) follwed by an acount id (int) and then the amount (int)
Resource contents: e.g. an example of a pf the returned resource
“Enter screenshot here”
...
URI: http://localhost:49000/api/customers/{customerId}/accounts/{accountId}/transfer/{accountId}/{amount}
HTTP verb: PUT
...
URI: http://localhost:49000/api/accounts
HTTP verb: GET
Parameters: Null
Resource contents: e.g. an example of a pf the returned resource
“Enter screenshot here”
...
URI: http://localhost:49000/api/accounts/{id}
HTTP verb: GET
...
URI: http://localhost:49000/api/accounts?accountType={accountType}
HTTP verb: GET
...
URI: http://localhost:49000/api/accounts/{accountId}/transactions/{transactionId}
HTTP verb: GET
...
URI: http://localhost:49000/api/accounts/balance/{accountNum}
HTTP verb: GET
